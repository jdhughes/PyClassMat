...
\begin{center}\includegraphics[scale=.4]{figures/socialwater1.pdf}\end{center}
\end{frame}
...
\column{.4\textwidth}
\begin{center}\includegraphics[scale=.3]{figures/SW_msg.pdf}\end{center}
...
\begin{center}\includegraphics[scale=.25]{figures/COVERcloudPEST.pdf}\end{center}
\end{frame}


\begin{frame}[fragile]
\frametitle{cloudPEST}
\begin{center}\includegraphics[scale=.6]{figures/cloudCONFIG.pdf}\end{center}
\end{frame}

\begin{frame}[fragile]
\frametitle{cloudPEST}
\begin{center}\includegraphics[scale=.42]{figures/cloudPROD.pdf}\end{center}
\end{frame}
